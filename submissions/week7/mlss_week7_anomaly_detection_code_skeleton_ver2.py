# -*- coding: utf-8 -*-
"""mlss_week7_anomaly_detection_code_skeleton_ver2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1t25ozzUAaLXph39DhcJdyGinIYVz84U9
...
def compute_ViM_principal_space_and_alpha(training_data_loader, model_net, verbose = False):
    ...
    #u = -np.matmul(pinv(feature_id_train), b)
    ...
    ps = U[:, :k] # Principal Space
    assert ps.shape == (128, k)
    principal_space = ps
...
def ViM_anomaly_score_calculator(output, penultimate):
    ...
    score_id = np.array([to_np(vl) - energy])
    #score_id = 1.0/(1 + np.exp(-score_id))
